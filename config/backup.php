...
return [
    ...
    'backup' => [
        ...
        'source' => [
             ...
             */
            /*
             * On SQLite the database is a single file that is already captured by the
             * file backup above, so no dedicated dumper is needed. When moving to
             * MySQL/PostgreSQL for production, list the connection here instead, e.g.
             * ['mysql'].
             */
